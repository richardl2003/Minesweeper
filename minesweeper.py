...
class Sentence():
    ...
    def known_mines(self):
        ...
        # Any time the number of cells is equal to count, all the cells are mines
    ...
    def known_safes(self):
        ...
        # When count = 0, all the cells are safe
        if self.count == 0:
            return self.cells
        else:
            return set()
    ...
    def mark_mine(self, cell):
        ...
        # Check to see if the cell is in the set
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                # Checking if the neighbor cell is safe
                if (i, j) in self.safes:
                    continue
        
                # Checking if we are on the current cell
                if (i, j) == cell:
                    continue
                    
                # Checking if the neighbor cell is a mine
                if (i, j) in self.mines:
                    count -= 1
                    continue

                # Add to sentence if within the bounds of game board
                if 0 <= i < self.height and 0 <= j < self.width:
        ...
        # Mark guaranteed mines and cells 
        for sentence in self.knowledge:
        ...
        for i in range(len(self.knowledge)): 
            ...
            for j in range(i, len(self.knowledge)):
                ...
                if set1.issubset(set2):
                    ...
                    # Make a new sentence
                    subset = Sentence(new_set, new_count)
